...
It's useful for debugging PDF form filling issues.
"""
...
if __name__ == "__main__":
    # Use the provided PDF path or default to the template
    if len(sys.argv) > 1:
        pdf_path = sys.argv[1]
    else:
        # Default path to the application template
        base_dir = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
        pdf_path = os.path.join(base_dir, 'applications', 'ApplicationTemplate', 'Eternity Capital - Application Form.pdf')
